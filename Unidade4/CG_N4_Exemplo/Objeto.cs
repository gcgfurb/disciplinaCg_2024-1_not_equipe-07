        ...
        public void ObjetoAtualizar()
        {
            if (texture != null)
            {
                ...
                for (int i = 0; i < vertices.Length; i += 5)
                {
                  ...
                  vertices[i + 3] = coordenadas[contadorCoordenadas][0];
                  vertices[i + 4] = coordenadas[contadorCoordenadas][1];
                  ptoLista++;

                  contadorCoordenadas++;
                  if (contadorCoordenadas == 4) contadorCoordenadas = 0;
                }*/
                ...
                var textCoordLocation = _shaderObjeto.GetAttribLocation("aTexCoord");
